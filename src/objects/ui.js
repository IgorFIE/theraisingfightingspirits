...
export class UI {
    ...
    populateEnergyCanvas() {
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt("ENERGY"), this.energyCanvasCtx, GameVars.pixelSize, 33, 12);
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt(this.currentEnergy), this.energyCanvasCtx, GameVars.pixelSize, 33, 32, "black", 3);

        generateSmallBox(this.energyCanvas, 5, 63, 56, 30, GameVars.pixelSize, "black", "gray");
        drawPixelTextInCanvasCtx(convertTextToPixelArt("ENABLE"), this.energyCanvasCtx, GameVars.pixelSize, 34, 70);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("MONETIZATION"), this.energyCanvasCtx, GameVars.pixelSize, 34, 78);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("GAIN +1 ENERGY"), this.energyCanvasCtx, GameVars.pixelSize, 34, 86);
    }
    ...
    populateTurnControllersCanvas() {
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt("ENABLE"), this.turnControllersCtx, GameVars.pixelSize, 34, 28);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("MONETIZATION"), this.turnControllersCtx, GameVars.pixelSize, 34, 35);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("DRAW +1"), this.turnControllersCtx, GameVars.pixelSize, 34, 42);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("EXTRA CARD"), this.turnControllersCtx, GameVars.pixelSize, 34, 49);
    ...
    drawEndTurnBtn() {
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt("END TURN"), this.endTurnCtx, GameVars.pixelSize, 34, 12);
    }
    ...
    drawPreviousBtn() {
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt("PREVIOUS SOUL"), this.previousSoulCtx, GameVars.pixelSize, 34, 10);
    }
    ...
    drawNexSoulBtn() {
        ...
        drawPixelTextInCanvasCtx(convertTextToPixelArt("NEXT SOUL"), this.nextSoulCtx, GameVars.pixelSize, 34, 12);
    }

    drawTurnCounter() {
        this.turnCounterCtx.clearRect(0, 0, this.turnCounterCanvas.width, this.turnCounterCanvas.height);
        drawPixelTextInCanvasCtx(convertTextToPixelArt("TURN: " + GameVars.turnCount), this.turnCounterCtx, GameVars.pixelSize, 150 / GameVars.pixelSize, 25, "black", 2);
    }
}